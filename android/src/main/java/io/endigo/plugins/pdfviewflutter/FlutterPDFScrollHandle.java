...
public class FlutterPDFScrollHandle extends RelativeLayout implements ScrollHandle {
    ...
    public FlutterPDFScrollHandle(Context context) {
        this(context, false);
    }

    public FlutterPDFScrollHandle(Context context, boolean inverted) {
        super(context);
