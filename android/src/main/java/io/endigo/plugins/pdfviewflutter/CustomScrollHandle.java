...
public class CustomScrollHandle extends RelativeLayout implements ScrollHandle {
    ...
    public CustomScrollHandle(Context context, boolean inverted) {
        ...
        removeAllViews();
        View view = inflate(context, R.layout.custom_scroll_handle, this);
        textView = view.findViewById(R.id.page_no_textview);
    ...
    public void setupLayout(PDFView pdfView) {
        ...
        totalPageCount = pdfView.getPageCount();
    }
    ...
    public void setPageNum(int pageNum) {
        String text = String.valueOf(pageNum + "/" + totalPageCount);
